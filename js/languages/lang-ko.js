...
LANGUAGES.KO = {
    ...
    text: {
        ...
        'solar-system-list': {
            ...
            'earth':   ["지구",`???`,`???`],
            'moon':    ["달",`태양계에 오신 것을 환영합니다! 일부 행성을 자유롭게 탐험 할 수 있지만, 강력한 보상을<br>받기 위해서는 관측이 필요합니다. 관측을 시작하면 강제로 특이점 환생이 이루어지며<br>일부 연구 및 진화 트리가 초기화 되며(관측을 끝내면 다시 생깁니다),<br>블랙홀의 감소 효과가 ^0.5 로 고정되며 거의 모든 채광 이후의 기능이 비활성화 되며,<br>마지막으로 어떠한 바다도 탐험 할 수 없습니다. 우주 기지에서 ${toTextStyle('천체','observ')}를 생성해<br>업그레이드를 구매하여 진행을 더 빠르게 만들 수 있습니다. 난이도는 게임 진행에는<br>영향을 미치지 않지만 우주 기지의 기능을 더 많이 사용할 수 있도록 만듭니다.<br>자! 먼저 지구의 달부터 시작하겠습니다!<br>달이라고도 부르지만, '거대 충돌 가설'에서는 충돌 이전엔 '테이아' 라고 불렀습니다.`,`채광 승천과 새 ${toTextStyle('잔재물','black-hole')} 업그레이드를 해금합니다. 채광 승천은 강제로 특이점 환생을 진행하는<br>대신 강력한 보너스와 여러 광석을 해금할 수 있습니다.`],
