    ...
    text: {
        ...
        get 'singularity-milestones'() {
            return [
                ...
                [`3 Черных Дыры`,`Интервалы автоматизаторов, пре-Культивизационные функции, 10 ${toTextStyle("Человекоподобных",'humanoid')} Акул остаются при сбросе. Открывает ещё новые изучения.`],
                ...
                [`8 Черных Дыры`,`Наказания ("Черной Дыры",'black-hole')} теперь не будет, если ты сформировал 8 текущих ${toTextStyle("Черных Дыр",'black-hole')}. Анимация при формировании больше не проигрывается. Открывает новая функция.`],
        ...
        get 'reset-sacrifice-message'() {
            ...
            Отправка ваших акул жертву, сбросит все, что и ${c} но также, текущие черные дыры (первые 7 вех остануться), остатки, остаточные улучшения и некоторые изучения взамен на ${toTextStyle('Темную Материю','black-hole')}.<br>
        ...
        'radio-desc' : {
            ...
            'notify': ['Уведомление Вкладкой',['Выключенн','Включен']],
        },
