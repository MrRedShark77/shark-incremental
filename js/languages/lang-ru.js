LANGUAGES.RU = {
    ...
    text: {
        ...
        get 'radioactive-summary'() {
            ...
            Пока эксперимент активен, все ядерные реакторы не работают и количество съеденной ${toTextStyle('Рыбы','fish')}, ${toTextStyle('Престижных','prestige')} осколков, ресурсов первых четырех океанов коренятся на 3.
