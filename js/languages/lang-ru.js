...
LANGUAGES.RU = {
    ...
    text: {
        ...
        'evolution-tree-ctn': [
            ...
            ["Сжатое Ядро", x=>`${toTextStyle("Магматические",'core')} фрагменты подняты на <b>${format(x)}</b> порядка.`,`${toTextStyle("Магматические",'core')} фрагменты подняты на <b>${format(x)}</b> порядка вновь.`],
        ...
        'mining-tier-bonus': [
            ...
            x=>`Количество добываемого <b>Радия-223</b> amount is увеличено в <b>${formatMult(x)}</b>.`,
            x=>`Количество добываемого <b>Урана-235</b> amount is увеличено в <b>${formatMult(x)}</b>.`,
        ],
